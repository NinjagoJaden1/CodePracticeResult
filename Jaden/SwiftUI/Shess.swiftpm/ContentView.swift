    ...
    var body: some View {
        ZStack{
                        ...
                        ForEach(0..<8,id:\.self){ x in
                            ...
                            .onTapGesture {
                                if vm.last == nil{
                                    ...
                                    print(showProm)
                                    for i in 0...7{
                                        if vm.board[0][i].token.name == "Minnow"{
                                            print("11")
                                            showProm = true
                                        }else if vm.board[7][i].token.name == "Minnow"{
                                            print("2")
                                            showProm = true
                                        }
                                    }
            ...
            if showProm == true{
                ZStack{
                    ...
                    VStack{
                        ...
                        ForEach(["Whale","Puffer","Sword","Seahors"],id:\.self){ i in
                            Button(i){
                                vm.promote = i
                                showProm = false
            ...
            if vm.mate != .clear{
                Rectangle()
                    .fill(vm.mate)
                winScreen(player1: Player(color: .black, name:"Black", score: 1), player2: Player(color: .white, name:"White",score: 0), reason: "Resignation")
            }
        }
        Button("Resign"){
            vm.mate = .black
